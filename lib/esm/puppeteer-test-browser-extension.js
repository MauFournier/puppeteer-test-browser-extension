...
const bootstrapExtension = function (options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const browser = yield puppeteer.launch(Object.assign({ headless: false, executablePath: process.env.PUPPETEER_EXEC_PATH, devtools, args: [
        ...
        const devToolsFrame = yield getDevtoolsPanel(contentPage, { panelName: devtoolsPage, timeout: 7000 });
        return {
            contentPage,
            browser,
            extensionUrl,
